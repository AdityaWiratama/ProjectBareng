...
<div class="container mt-5">
    ...
    <p class="text-center text-muted">Berlaku dari <strong>16 - 23 Mei 2025</strong></p>
    <div class="row mt-4">
            ...
            <div class="col-md-4 mb-4 d-flex">
                <div class="card card-custom w-100">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="/order?product={{ $promo['slug'] }}" class="btn btn-order mt-2">Pesan</a>
                    </div>
                </div>
            </div>
        @endforeach
            ...
            <div class="col-md-4 mb-4 d-flex">
                <div class="card card-custom w-100">
                    ...
                    <div class="card-body text-center d-flex flex-column justify-content-between">
                        ...
                        <a href="/order?product={{ $variant['slug'] ?? Str::slug($variant['name']) }}" class="btn btn-order mt-3">Pesan</a>
                    </div>
                </div>
            </div>
        @endforeach
